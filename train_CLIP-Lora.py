...
def run_program(x):
    ...
    eval_dataloader = DataLoader(val_dataset, shuffle=True, batch_size=1, collate_fn=data_collator)
    ...
    for epoch in range(num_epochs):
        ...
        for batch in train_dataloader:
            ...
            _, predicted = logits_per_image.max(1)  # Get the index of the max logit (predicted label)
    ...
    model.save_pretrained('outputs_CLIP-Lora')
    processor.save_pretrained('outputs_CLIP-Lora')
    print("model saved")
