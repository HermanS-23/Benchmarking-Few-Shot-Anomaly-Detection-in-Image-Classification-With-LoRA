...
def run_program(x):
    ...
    val_dataloader = DataLoader(val_dataset, batch_size=1, shuffle=True, collate_fn=data_collator)
    ...
    # Save the model
    model.save_pretrained("outputs_dinov2")
    image_processor.save_pretrained("outputs_dinov2")
    print("model saved")
